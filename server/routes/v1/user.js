...
module.exports = (api) => {
  ...
  router.get(`${URL_BASE}/:id`, auth([role.type.NORMAL_USER, role.type.ADMIN]), async (req, res) => userController.findById(req, res));
  router.put(`${URL_BASE}/:id`, auth([role.type.NORMAL_USER, role.type.ADMIN]), async (req, res) => userController.update(req, res));
